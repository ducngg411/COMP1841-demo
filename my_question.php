...
$sql = "SELECT COUNT(id) AS count FROM questions q WHERE q.mem_id = ?";
        ...
        <div class="grid">
            ...
            <div class="container__content">
                <div class="container__h1-button container__h1-button-question">
                    ...
                    <a href="create_question.php"><button class="add_student add_student-question">ADD NEW QUESTION</button></a>
                </div>
